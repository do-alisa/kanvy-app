                        ...
                        <CardContent className="p-4 sm:p-6">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="h-10 w-10 sm:h-12 sm:w-12 bg-pink-100 rounded-lg flex items-center justify-center">
                                    <FolderKanban className="h-5 w-5 sm:h-6 sm:w-6 text-pink-600" />
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    {boards.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
                            ...
                            <Card className="border-2 border-dashed border-gray-300 hover:border-pink-400 transition-colors cursor-pointer group">
                                <CardContent onClick={handleCreateBoard} className="p-4 sm:p-6 flex flex-col items-center justify-center h-full min-h-[200px]">
                                    <Plus className="h-6 w-6 sm:h-8 sm:w-8 text-gray-400 group-hover:text-pink-600 mb-2" />
                                    <p className="text-sm sm:text-base text-gray-600 group-hover:text-pink-600 font-medium">
                                        Create new board
                                    </p>
                                </CardContent>
                            </Card>
                        ...
                        <div>
                            ...
                            <Card className="mt-4 border-2 border-dashed border-gray-300 hover:border-pink-400 transition-colors cursor-pointer group">
