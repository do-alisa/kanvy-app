      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            ...
            <span className="text-pink-600">finally.</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Kanvy helps teams move work forward. Collaborate, manage
            projects, and reach new productivity peaks. Accomplish it all
            with Kanvy!
          </p>
          <h2 className="text-3xl md:text-4xl font-bold text-pink-500 mb-10">⠂⠄⠄⠂⠁⠁⠂⠄⠄⠂⠁⠁⠂⠄⠄⠂ ⠂⠄⠄⠂☆</h2>
      ...
      <section className="bg-pink-600 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-pink-100 mb-8 max-w-2xl mx-auto">
            Join thousands of teams who are already using Kanvy to
            organize their work.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              <FolderKanban className="h-6 w-6 text-pink-400" />
              <span className="text-xl font-bold">Kanvy</span>
            </div>
            <div className="flex items-center space-x-6 text-sm text-gray-400">
              <span>© 2024 Kanvy. All rights reserved.</span>
